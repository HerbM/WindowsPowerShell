...
@{
    ...
    TextEditor = 'np'        # Default text editor used by the Edit-File function
    ...
    SmtpFrom = 'HerbMartin@Gmail.com' # These settings are used by the PSCX Send-SmtpMail cmdlet.
